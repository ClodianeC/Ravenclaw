...
<main>
    ...
    <a href="../index.php" id="retourAccueil" class="retour boutonIcone"><div class="icon"></div><p>Retour à l'accueil</p></a>
    ...
    <ul class="liste">
        ...
        for($intCptAffichageItems = 0; $intCptAffichageItems<count($arrItems); $intCptAffichageItems++){
            ...
            echo "<form action='creer_modifier/index.php' method='get'>
                  ...
                  <button type='submit' name='edit' value='edit' class='buttonEdit boutonIcone'><div class='icon'></div><p>Éditer</p></button>
                  </form>";
            echo "<form action='index.php' method='get'>
                     <input type='text' hidden name='id_liste' id='id_liste' value='$idListeActu'>
                     <input type='text' hidden name='id_item' id='id_item' value='$id_item'>
                     <button type='submit' name='delete' value='delete' class='buttonDelete boutonIcone'><div class='icon'></div><p>Supprimer</p></button>
                  </form>";
            echo "</div>";
            echo "</li>";
        }
